...
let CouponController = class CouponController {
    ...
    async findAll(onlyValid, onlyExpired, minSpent) {
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('onlyValid')),
    __param(1, (0, common_1.Query)('onlyExpired')),
    __param(2, (0, common_1.Query)('minSpent')),
    __metadata("design:type", Function),
